...
import { lineupIaProducts } from "../../data/lineupIaTables";
...
type LineupIaAllTablesProps = {
  configuratorHref?: string;
  configuratorExternal?: boolean;
};

/**
 * Preview page — all Industrial Automation `product_etc.line_up` tables from
 * docs/product-etc-line-up-tables-ia.txt
 */
export default function LineupIaAllTables({
  configuratorHref = "",
  configuratorExternal = false,
}: LineupIaAllTablesProps) {
