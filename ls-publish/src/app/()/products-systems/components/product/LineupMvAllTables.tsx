...
import { lineupMvProducts } from "../../data/lineupMvTables";
...
type LineupMvAllTablesProps = {
  configuratorHref?: string;
  configuratorExternal?: boolean;
};

/**
 * Preview page — all MV `product_etc.line_up` tables from
 * docs/product-etc-line-up-tables-mv.txt
 */
export default function LineupMvAllTables({
  configuratorHref = "",
  configuratorExternal = false,
}: LineupMvAllTablesProps) {
