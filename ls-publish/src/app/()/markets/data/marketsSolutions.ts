...
const productImg = {
  powerTransformer:
    "/pub/img/devices-systems/products/power-transformer.webp",
  ul67Panelboard: "/pub/img/devices-systems/products/ul67-panelboard.webp",
  metalClad: "/pub/img/devices-systems/products/metal-clad-switchgear.webp",
  metalEnclosed:
    "/pub/img/devices-systems/products/metal-enclosed-load-interrupter-switchgear.webp",
  ul1558: "/pub/img/devices-systems/products/ul1558-switchgear.webp",
  padmount: "/pub/img/devices-systems/products/padmount-transformer.webp",
  castResin: "/pub/img/devices-systems/products/cast-resin-transformer.webp",
  loadInterrupter:
    "/pub/img/devices-systems/products/load-interrupter-switch.webp",
  susolVcb: "/pub/img/devices-systems/products/susol-ul-vcb.webp",
  susolMccb: "/pub/img/devices-systems/products/susol-ul-mccb.webp",
  dcProducts:
    "/pub/img/devices-systems/products/iec-dc-acb-and-switch-disconnector.webp",
  eHouse: "/pub/img/devices-systems/products/e-house.webp",
  /** SCADA — 더미 유지 */
  scada: "/pub/img/markets/solutions/product_scada.png",
  fallback: "/pub/img/main/product_01.jpg",
} as const;
