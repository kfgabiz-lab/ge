...
export const powerGridHero = {
  ...
  title: "Power Grid",
  heroImage: "/pub/img/markets/power-grid/hero/hero.jpg",
};
...
export const powerGridIndustryTabs: IndustryTab[] = [
  {
    ...
    image: "/pub/img/markets/power-grid/explore/img_generation.jpg",
  },
  {
    id: "microgrids",
    label: "Microgrids",
    ...
    image: "/pub/img/markets/power-grid/explore/img_microgrids.jpg",
  },
  {
    id: "bess",
    label: "BESS",
    ...
    image: "/pub/img/markets/power-grid/explore/img_bess.jpg",
  },
  {
    id: "utilities",
    label: "Utilities",
    ...
    image: "/pub/img/markets/power-grid/explore/img_utilities.jpg",
  },
  {
    id: "renewables",
    label: "Renewables",
    ...
    image: "/pub/img/markets/power-grid/explore/img_renewables.jpg",
  },
];
...
export const powerGridReferences: ReferenceItem[] = [
  {
    id: "pg-ref-1",
    href: "",
    image: "/pub/img/markets/power-grid/references/ref_01.jpg",
    ...
    modal: {
      ...
      images: ["/pub/img/markets/power-grid/references/ref_01.jpg"],
      overview: [
        "LS ELECTRIC ultimately succeeded in winning the contract to supply EHV switchgears, LV switchgears, and integrated power distribution for this large-scale commercial development.",
  ...
  },
  {
    id: "pg-ref-2",
    href: "",
    image: "/pub/img/markets/power-grid/references/ref_02.jpg",
    ...
    modal: {
      ...
      images: ["/pub/img/markets/power-grid/references/ref_02.jpg"],
      overview: [
        "As such, we supplied various equipment such as 38kV MV switchgears, MV transformers, UL 891 switchgears, and coordinated low-voltage distribution for the new headquarters campus.",
  ...
  },
  {
    id: "pg-ref-3",
    href: "",
    image: "/pub/img/markets/power-grid/references/ref_03.jpg",
    ...
    modal: {
      ...
      images: ["/pub/img/markets/power-grid/references/ref_03.jpg"],
      overview: [
        "Owing to the next-generation EMS constructed at the site, operators can now optimally manage power generation, analyze systems, and improve grid-wide operational visibility.",
...
export const powerGridBenefits: BenefitItem[] = [
  {
    ...
    image: "/pub/img/markets/power-grid/benefits/benefit_01.jpg",
  },
  {
    id: "pg-b2",
    href: "",
    ...
    image: "/pub/img/markets/power-grid/benefits/benefit_02.jpg",
    reverse: true,
  },
  {
    id: "pg-b3",
    ...
    image: "/pub/img/markets/power-grid/benefits/benefit_03.jpg",
  },
  {
    id: "pg-b4",
    href: "",
    ...
    image: "/pub/img/markets/power-grid/benefits/benefit_04.jpg",
    reverse: true,
  },
];
...
export const powerGridSustainabilityCards: SustainabilityCard[] = [
  {
    id: "pg-sus-1",
    image: "/pub/img/markets/power-grid/sustainability/card_01.jpg",
  ...
  {
    id: "pg-sus-2",
    image: "/pub/img/markets/power-grid/sustainability/card_02.jpg",
...
export const powerGridWhyItems: WhyItem[] = [
  {
    ...
    icon: "/pub/img/markets/power-grid/why/why_01.svg",
  },
  {
    id: "pg-why-2",
    href: "",
    ...
    icon: "/pub/img/markets/power-grid/why/why_02.svg",
  },
  {
    id: "pg-why-3",
    href: "",
    ...
    icon: "/pub/img/markets/power-grid/why/why_03.svg",
  },
];
...
export const powerGridProducts: ProductItem[] = [
  {
    ...
    image: "/pub/img/markets/power-grid/products/product_01.jpg",
    title: "Metasol MS",
  ...
  },
  {
    id: "pg-p2",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_02.jpg",
  ...
  },
  {
    id: "pg-p3",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_03.jpg",
    title: "Metasol MMS",
    category: "Metasol Contactor & Overload Relay",
    badges: 2,
  },
  {
    id: "pg-p4",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_04.jpg",
    title: "Susol UL MCCB",
  ...
  },
  {
    id: "pg-p5",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_05.jpg",
    title: "DMPi",
  ...
  },
  {
    id: "pg-p6",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_06.jpg",
    title: "IMP",
  ...
  },
  {
    id: "pg-p7",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_07.jpg",
    title: "MMP",
  ...
  },
  {
    id: "pg-p8",
    href: "",
    image: "/pub/img/markets/power-grid/products/product_08.jpg",
    title: "GMP",
