...
import type { ServiceTrainingCourse } from "@/data/services/serviceTrainingContent";

export default function ServiceTrainingCard({
  course,
}: {
  course: ServiceTrainingCourse;
}) {
  const detailHref = `/services/service-training/${course.id}`;
