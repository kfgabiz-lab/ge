...
export const serviceCenterPage = {
    ...
    items: [
      {
        ...
        icon: "/pub/img/services/service-center/icon-warranty-policy.svg",
      ...
      },
      {
        ...
        icon: "/pub/img/services/service-center/icon-request-service.svg",
      ...
      },
      {
        ...
        icon: "/pub/img/services/service-center/icon-download-center.svg",
      ...
      },
      {
        ...
        icon: "/pub/img/services/service-center/icon-tech-hub.svg",
  ...
  banner: {
    ...
    backgroundImage: "/pub/img/services/service-center/help-01.jpg",
    backgroundImageMobile:
      "/pub/img/services/service-center/banner-still-need-help.png",
  },
  offering: {
    title: "Our Services",
    description:
    ...
    slides: [
      {
        ...
        image: "/pub/img/services/service-center/offering-01.jpg",
      },
      {
        id: "offering-02",
        number: "02",
        ...
        image: "/pub/img/services/service-center/offering-02.jpg",
      },
      {
        id: "offering-03",
        number: "03",
        ...
        image: "/pub/img/services/service-center/offering-03.jpg",
      },
      // {
      //   id: "offering-04",
      //   number: "04",
      ...
      //   image: "/pub/img/services/service-center/offering-04.jpg",
      // },
    ],
  },
  serviceFlow: {
    ...
    icons: {
      ...
      check: "/pub/img/services/service-center/service-flow-icon-check.svg",
      checkEnd: "/pub/img/services/service-center/service-flow-icon-check-end.svg",
      endDot: "/pub/img/services/service-center/service-flow-icon-dot.svg",
    },
    steps: [
      {
        id: "issue",
  ...
  gics: {
    ...
    ctaHref: GICS_REQUEST_URL,
    image: "/pub/img/services/service-center/g-ics-hero.jpg",
    ...
    cards: [
      {
        ...
        href: GICS_REQUEST_URL,
        external: true,
        image: "/pub/img/services/service-center/help-01.jpg",
      },
      {
        id: "warranty",
        ...
        href: GICS_REQUEST_URL,
        external: true,
        image: "/pub/img/services/service-center/help-02.jpg",
      },
      {
        id: "contact",
        title: "Contact Us",
        ...
        external: false,
        image: "/pub/img/services/service-center/help-03.jpg",
      },
    ],
  },
};
