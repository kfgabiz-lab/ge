...
import SalesTrainingCard from "./SalesTrainingCard";
...
export default function SalesTrainingCurriculum() {
  const { curriculum } = salesTrainingPage;
      ...
      <div className="inner">
        ...
        <ul className="support_service_training_curriculum__list">
          {curriculum.courses.map((course) => (
            ...
            >
              <SalesTrainingCard course={course} />
            </li>
          ))}
        </ul>
