...
const DEFAULT_IMAGE_SRC = "/pub/img/devices/product/banner_hub_video.jpg";
const DEFAULT_BACKGROUND_SRC = "/pub/img/devices/product/banner_hub_bg.png";
const DEFAULT_BACKGROUND_SRC_MO = "/pub/img/devices/product/banner_hub_bg_mo.png";
