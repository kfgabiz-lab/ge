const IMG = "/pub/img/services/request-for-training";

export const requestForTrainingAssets = {
  stepBarBg: `${IMG}/step-bar-bg.png`,
  recaptcha: "/pub/img/services/engineering-training/session-recaptcha.png",
} as const;
...
const requestForTrainingStepDefinitions = [
  {
    ...
    iconUpcoming: "/pub/ico/ico_request_training_info_24.svg",
    iconActive: "/pub/ico/ico_request_training_info_24.svg",
  },
  {
    id: "requested-dates",
    stepLabel: "Step 2",
    title: "Requested Date(s) of Training",
    iconUpcoming: "/pub/ico/ico_request_training_calendar_24.svg",
    iconActive: "/pub/ico/ico_request_training_calendar_active_24.svg",
  },
  {
    id: "class-location",
    stepLabel: "Step 3",
    title: "Training Class Location",
    iconUpcoming: "/pub/ico/ico_request_training_location_24.svg",
    iconActive: "/pub/ico/ico_request_training_location_active_24.svg",
  },
  {
    id: "class-details",
    stepLabel: "Step 4",
    title: "Training Class Details",
    iconUpcoming: "/pub/ico/ico_request_training_file_24.svg",
    iconActive: "/pub/ico/ico_request_training_file_active_24.svg",
  },
] as const;

export const requestForTrainingCheckIcon = "/pub/ico/ico_request_training_check_16.svg";
...
export function getRequestForTrainingSteps(currentStep: RequestForTrainingStepNumber) {
  return requestForTrainingStepDefinitions.map((step, index) => {
    ...
    const arrow =
      status === "active"
        ? "/pub/ico/ico_request_training_arrow_active_24.svg"
        : "/pub/ico/ico_request_training_arrow_24.svg";
