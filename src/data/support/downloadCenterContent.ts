import type { ProductDownloadItem } from "@/app/()/devices-systems/data/productDetailContent";
...
/**
 * Figma 3670:30532 — Download Center / List (Accordion).
 * 버전 드롭다운은 `versions`가 있는 항목에만 노출된다 (Figma 디자인 기준).
 */
