...
-- ────────────── tiptap-editor.tsx 다국어 처리 신규 키 ──────────────
INSERT INTO message_resource ("key", ko, en, is_active, resource_type, created_by, created_at, updated_by, updated_at)
VALUES

('common.editor.paragraph', '본문', 'Paragraph', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.heading_style', '제목 스타일', 'Heading Style', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.bold', '굵게 (Ctrl+B)', 'Bold (Ctrl+B)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.italic', '기울임 (Ctrl+I)', 'Italic (Ctrl+I)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.strike', '취소선', 'Strikethrough', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.underline', '밑줄 (Ctrl+U)', 'Underline (Ctrl+U)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.insert_horizontal_rule', '수평선 삽입', 'Insert Horizontal Rule', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.bullet_list', '글머리 목록', 'Bullet List', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.ordered_list', '번호 목록', 'Ordered List', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.indent', '들여쓰기', 'Indent', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.outdent', '내어쓰기', 'Outdent', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.insert_table', '테이블 삽입', 'Insert Table', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.add_row_before', '행 위에 추가', 'Add Row Above', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.add_row_after', '행 아래에 추가', 'Add Row Below', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.delete_row', '행 삭제 (마지막 행이면 표 삭제)', 'Delete Row (deletes table if last row)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.add_col_before', '열 왼쪽에 추가', 'Add Column Left', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.add_col_after', '열 오른쪽에 추가', 'Add Column Right', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.delete_col', '열 삭제 (마지막 열이면 표 삭제)', 'Delete Column (deletes table if last column)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.delete_table', '표 삭제', 'Delete Table', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.cell_bg_color', '셀 배경색', 'Cell Background Color', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.clear_bg_color', '배경색 지우기', 'Clear Background Color', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.insert_image', '이미지 삽입', 'Insert Image', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.insert_link', '링크 삽입', 'Insert Link', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.highlight', '형광펜', 'Highlight', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.align_left', '왼쪽 정렬', 'Align Left', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.align_center', '가운데 정렬', 'Align Center', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.align_right', '오른쪽 정렬', 'Align Right', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.align_justify', '양쪽 정렬', 'Justify', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.text_color', '글자 색상', 'Text Color', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.superscript', '위첨자', 'Superscript', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.subscript', '아래첨자', 'Subscript', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.insert_youtube', '유튜브 영상 삽입', 'Insert YouTube Video', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.view_html_source', 'HTML 소스 보기', 'View HTML Source', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.text_mode', '텍스트 모드', 'Text Mode', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.preview', '미리보기', 'Preview', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.url_input_tab', 'URL 입력', 'URL Input', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.file_upload_tab', '파일 업로드', 'File Upload', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.image_url_label', '이미지 URL', 'Image URL', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.alt_text_label', '대체 텍스트 (선택)', 'Alt Text (optional)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.image_description_placeholder', '이미지 설명', 'Image description', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.cancel', '취소', 'Cancel', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.insert', '삽입', 'Insert', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.select_image_file_label', '이미지 파일 선택', 'Select Image File', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.uploading', '업로드 중...', 'Uploading...', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.click_to_select_image', '클릭하여 이미지 선택', 'Click to select an image', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.close', '닫기', 'Close', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.remove_link', '링크 제거', 'Remove Link', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.table_size_dialog_title', '표 삽입', 'Insert Table', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.row_label', '행(row)', 'Row(s)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.column_label', '열(column)', 'Column(s)', true, 'WORD', 'system', NOW(), 'system', NOW()),
('common.editor.apply', '적용', 'Apply', true, 'WORD', 'system', NOW(), 'system', NOW()),

('common.editor.blob_url_not_allowed', 'blob: 임시 URL은 사용할 수 없습니다. 이미지를 다시 업로드해주세요.', 'The blob: temporary URL cannot be used. Please re-upload the image.', true, 'SENTENCE', 'system', NOW(), 'system', NOW()),
('common.editor.blob_url_not_saveable', 'blob: 임시 URL은 저장할 수 없습니다. 이미지를 다시 업로드해주세요.', 'The blob: temporary URL cannot be saved. Please re-upload the image.', true, 'SENTENCE', 'system', NOW(), 'system', NOW()),
('common.editor.image_upload_failed', '이미지 업로드에 실패했습니다.', 'Failed to upload the image.', true, 'SENTENCE', 'system', NOW(), 'system', NOW()),
('common.editor.youtube_url_prompt', '유튜브 URL을 입력하세요:', 'Enter the YouTube URL:', true, 'SENTENCE', 'system', NOW(), 'system', NOW())

ON CONFLICT ("key") WHERE is_deleted = false DO NOTHING;
