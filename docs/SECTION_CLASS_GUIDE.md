...
| `main_cards` | `MainCards.tsx` | GNB `marketsMegaMenu` grid 연동 |
...
key-visual 6페이지 공통: `MainHeader` + breadcrumb · hero sticky scroll-over · `markets_intro` padding(마진 대체) · GNB Markets 링크: data-center · commercial-residential · industrial
...
| (default) | — | industrial | diagram only (`groups: []`) |
...
| `markets_why` | `MarketsWhy.tsx` | 공통 · `.icon_area img` · SVG 경로 `img_why_*.svg` / data-center `why/why_*.svg` · mobile `max-width: 780px` 공용 (`markets.css`) |
| `markets_products` | `MarketsProducts.tsx` | `badgesType2Only` (type1 제외) |
| `common_banner_01` | `CommonBanner01.tsx` | 페이지 하단 CTA |
| `highlight_news` | `HighlightNewsSection.tsx` | `--markets` · `markets-highlights` |
...
| `company-blog-list` | `CompanyBlogPage.tsx` | 툴바 · 리스트 · 페이지네이션 |
...
| `company-press-list` | `CompanyPressListSection.tsx` | 툴바(`GuideSelect` + `GuideSelectIcon` · `#dropdown`) · 그리드 · 페이지네이션 |
...
| `company-articles-featured` | `CompanyArticlesFeatured.tsx` | Featured 카드 · `btn-text-30` Explore |
| `company-articles-list` | `CompanyArticlesListSection.tsx` | 툴바 · 그리드 · 페이지네이션 |
...
| 3 | `company-america-shaping` | `CompanyAmericaPage.tsx` | Shaping What's Next · `company-america-shaping__block` |
| 4 | `company-america-business` | `CompanyAmericaPage.tsx` | Core Business · `company-america-business__row--reverse` |
...
| 7 | `company-america-leaders` | `CompanyAmericaPage.tsx` | 리더 카드 그리드 |
...
|------|--------|----------|------|
| 1 | `company-about-title` | `CompanyAboutTitleSection.tsx` | 공통 |
| 2 | `company-about-intro` | `CompanyAboutIntroSection.tsx` | 공통 · 히어로 · 2열 텍스트 (Figma 4717:56038) |
| 3 | `company-ls-electric-highlights` | `CompanyLsElectricPage.tsx` | 2025 Highlights · `btn-text-30` IR 링크 |
| 4 | `company-ls-electric-business` | `CompanyLsElectricPage.tsx` | Our Business · 4 cards (Figma 4717:55930) |
| 5 | `company-ls-electric-global` | `CompanyLsElectricPage.tsx` | Global Network · dark map · 4 stat cards (Figma 4717:54192) |
| 6 | `company-ls-electric-ptt` | `CompanyLsElectricPage.tsx` | PT&T · 3 cards (Figma 4717:54159) |
...
| 3 | `company-affiliate-list` | `CompanyAffiliateAmericaPage.tsx` | Figma [5565:134319](https://www.figma.com/design/FJa9pa866Be2aj5HYV717D/LSEA_%EB%94%94%EC%9E%90%EC%9D%B8?node-id=5565-134319) · 6 rows · logo 360×216 `#f5f7fa` · 항목별 `logoWidth`/`logoHeight` |
...
| `--press` | `/company/press/detail` | hero image · optional YouTube |
...
| `common_faq` | `CommonFaq.tsx` | `globals.css` · desktop `min-width: 781px` · mobile `max-width: 780px` 공용 |
...
| `support_download_contents` | `DownloadCenterContents.tsx` | `support-download-contents` — 레지스트리만 (`devices_product_downloads--center`) · empty `empty_icon.svg` |
...
| `support_contact_view_response_modal` (error) | `ContactUsViewResponseModalErrorPreview.tsx` | Figma 5565:128558 |
...
| 클래스 | 컴포넌트 | id · 비고 |
|--------|----------|-----------|
| `search_all_hero` | `SearchAllHero.tsx` | `search-all-hero` — `guide_field--search` 80px (Figma 4701:83900) |
| `search_all` | `SearchAllTabContent.tsx` | `search-all` — All 탭 · AI·Product/Documents/Media/Pages (Figma 4701:83900 · Pages 4701:83902) |
| `search_products` | `SearchProductsPanel.tsx` | `search-products` — Products 탭 (Figma 4701:84687) |
| `search_documents` | `SearchDocumentsPanel.tsx` | `search-documents` — Documents 탭 (Figma 4701:85037) |
| `search_media` | `SearchMediaPanel.tsx` | `search-media` — Media 탭 (Figma 4701:84177) |
...
| — | `SearchTabActiveFilters.tsx` | Products/Documents active chips · `ico_clear_12` |
...
페이지 래퍼: `.support-page--service-center` · `P-FO-SERV-010000P` · Figma PC [6023:137684](https://www.figma.com/design/FJa9pa866Be2aj5HYV717D/LSEA_%EB%94%94%EC%9E%90%EC%9D%B8?node-id=6023-137684)

PC 스타일: `@media (min-width: 781px)` · 모바일 미구현
...
| 5 | `support_service_flow` | `ServiceCenterFlow.tsx` | `service-center-flow` · 5단계 플로우 |
...
페이지 래퍼: `.support-page--warranty-policy` · `P-FO-SERV-020000P` · Figma [5552:123797](https://www.figma.com/design/FJa9pa866Be2aj5HYV717D/LSEA_%EB%94%94%EC%9E%90%EC%9D%B8?node-id=5552-123797)
...
페이지 래퍼: `.support-page--engineering-training` · `P-FO-SERV-030000P` · Figma [5552:120879](https://www.figma.com/design/FJa9pa866Be2aj5HYV717D/LSEA_%EB%94%94%EC%9E%90%EC%9D%B8?node-id=5552-120879)

| 순서 | 클래스 | 컴포넌트 | id · 비고 |
|------|--------|----------|-----------|
| 1 | `company-about-title` | `EngineeringTrainingTitle.tsx` → `CompanyAboutTitleSection` | `engineering-training-title` · Figma 5552:120911 |
| 2 | `support_service_training_intro` | `EngineeringTrainingIntro.tsx` | `engineering-training-intro` · Figma 5552:120902 |
| 3 | `support_service_training_curriculum` | `EngineeringTrainingCurriculum.tsx` | `engineering-training-curriculum` · Figma 5552:120881 |

데이터: `engineeringTrainingContent.ts` · breadcrumb: Services > Training > Engineering Training

### `support_service_training_intro`

```tsx
<section className="support_service_training_intro">
  <div className="inner">
    <div className="support_service_training_intro__media">
      <img className="support_service_training_intro__hero" src="..." alt="" />
    </div>
    <h2 className="support_service_training_intro__headline">...</h2>
    <p className="support_service_training_intro__desc">...</p>
  </div>
</section>
```

- 섹션 배경: `/pub/img/main/bg_section_main_info.jpg` · `inner` max 1440px
- `__media` 1440×450 · `__hero` `object-fit: cover`
...
| 헬퍼 (섹션 루트 아님) | 컴포넌트 | 비고 |
|----------------------|----------|------|
| `support_service_training_card` | `EngineeringTrainingCard.tsx` | 리스트 카드 (Figma [5552:120891](https://www.figma.com/design/FJa9pa866Be2aj5HYV717D/LSEA_%EB%94%94%EC%9E%90%EC%9D%B8?node-id=5552-120891)) · 380×246 · 상세 `/services/engineering-training/{courseId}` |

---

## Services — Engineering Training Detail (`/services/engineering-training/[courseId]`) — `training.css`

페이지 래퍼: `.support-page--engineering-training-detail` · `P-FO-SERV-030100P` · Figma [5552:120915](https://www.figma.com/design/FJa9pa866Be2aj5HYV717D/LSEA_%EB%94%94%EC%9E%90%EC%9D%B8?node-id=5552-120915)
...
| 순서 | 클래스 | 컴포넌트 | id · 비고 |
|------|--------|----------|-----------|
| 1 | `support_service_training_session_detail` | `EngineeringTrainingSessionDetail.tsx` | `engineering-training-session-detail` · 탭 · 아젠다 · 등록 · 사이드바 |

데이터: `engineeringTrainingSessionDetailContent.ts` · breadcrumb: Services > Training > Engineering Training > curriculum > session date

| 헬퍼 (섹션 루트 아님) | 컴포넌트 | 비고 |
|----------------------|----------|------|
| `EngineeringTrainingSessionCountdown` | countdown | Time Remaining (정적 UI · `session-countdown-bg.jpg`) |
...
| `support_service_training_session_detail__table` | agenda | No · Time · Contents · Trainer |
...
| 2 | `support_service_training_request` | `RequestForTraining.tsx` | `request-for-training` · 4단계 스텝바 · Step 1 폼 · Next 220×52 |
